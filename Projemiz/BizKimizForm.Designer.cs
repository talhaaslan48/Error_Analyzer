namespace Projemiz
{
	partial class BizKimizForm
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(BizKimizForm));
			panel1 = new Panel();
			button10 = new Button();
			label1 = new Label();
			...
			button10.Location = new Point(29, 50);
			...
			button1.Location = new Point(129, 146);
			button1.Name = "button1";
			button1.Size = new Size(258, 79);
			button1.TabIndex = 33;
			button1.Text = "BİZ KİMİZ?";
			...
			panel2.Location = new Point(112, 158);
			panel2.Name = "panel2";
