namespace Projemiz
{
	partial class SingleCharacterForm7
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			label5.Location = new Point(131, 286);
			...
			label20.Location = new Point(228, 285);
			...
			label22.Location = new Point(326, 285);
			...
			label21.Location = new Point(293, 285);
			...
			txtD4c.Location = new Point(126, 307);
			...
			txtD3c.Location = new Point(159, 307);
			...
			txtP3.Location = new Point(225, 307);
			...
			txtD2c.Location = new Point(192, 307);
			...
			txtP1.Location = new Point(323, 307);
			...
			txtP2.Location = new Point(291, 307);
			...
			txtD1c.Location = new Point(258, 307);
			...
			groupBox4.Size = new Size(580, 96);
			...
			label62.Size = new Size(277, 13);
			label62.TabIndex = 6;
			label62.Text = "Konum:        7          6          5          4         3         2        1";
			// 
			// button3
			// 
			...
			txtP2t.Location = new Point(239, 45);
			...
			label25.Location = new Point(274, 23);
			...
			label24.Location = new Point(241, 23);
			...
			label26.Location = new Point(142, 23);
			...
			txtD3t.Location = new Point(107, 45);
			...
			label23.Location = new Point(209, 23);
			...
			label27.Location = new Point(176, 23);
			...
			txtD1t.Location = new Point(206, 45);
			...
			label28.Location = new Point(111, 24);
			...
			txtP1t.Location = new Point(271, 45);
			...
			txtD2t.Location = new Point(140, 45);
			...
			label29.Location = new Point(79, 24);
			...
			txtP3t.Location = new Point(173, 45);
			...
			txtD4t.Location = new Point(74, 45);
			...
			txtK2.Location = new Point(179, 111);
			...
			txtK3.Location = new Point(145, 111);
			...
			txtK1.Location = new Point(212, 111);
			...
			txtP1son.Location = new Point(211, 70);
			...
			txtP1ilk.Location = new Point(212, 36);
			...
			txtP2son.Location = new Point(177, 70);
			...
			txtP2ilk.Location = new Point(179, 36);
			...
			txtP3son.Location = new Point(144, 70);
			...
			txtP3ilk.Location = new Point(145, 36);
			...
			label44.Location = new Point(126, 492);
			...
			label45.Location = new Point(127, 42);
			...
			label46.Location = new Point(158, 492);
			...
			label47.Location = new Point(160, 42);
			...
			label48.Location = new Point(223, 491);
			...
			label49.Location = new Point(189, 491);
			...
			label50.Location = new Point(192, 41);
			...
			label51.Location = new Point(321, 491);
			...
			label52.Location = new Point(288, 491);
			...
			label53.Location = new Point(256, 491);
			...
			label54.Location = new Point(225, 41);
			...
			txtD4r.Location = new Point(122, 513);
			...
			txtD3r.Location = new Point(154, 513);
			...
			txtD4f.Location = new Point(125, 62);
			...
			txtP3r.Location = new Point(221, 513);
			...
			txtD2r.Location = new Point(187, 513);
			...
			txtD3f.Location = new Point(158, 62);
			...
			txtP1r.Location = new Point(319, 513);
			...
			txtP2r.Location = new Point(286, 513);
			...
			txtD1r.Location = new Point(254, 513);
			...
			txtD2f.Location = new Point(190, 62);
			...
			txtD1f.Location = new Point(223, 62);
