namespace Projemiz
{
    partial class VRC
    {
		...
		private void InitializeComponent()
		{
			...
			label6.TabIndex = 51;
			label6.Text = "Bitleri değiştirebilirsiniz";
			// 
			// label7
			// 
			...
			label23.TabIndex = 68;
			label23.Text = "VRC Bit Kontrolü (Parity Biti ) :";
			// 
			// label25
			// 
			...
			label4.TabIndex = 98;
			label4.Text = "Hata Durum Kontrolü :";
			// 
			// label26
			// 
			...
			button1.Text = "Ders Videosuna Erişebilirsiniz";
			...
			button10.Location = new Point(30, 40);
			...
			panel2.Location = new Point(239, 40);
			panel2.Name = "panel2";
