namespace Projemiz
{
	public partial class FormAnaSayfa : Form
	{
		public FormAnaSayfa()
		{
			...
			// Label'ý baþlangýçta gizle
			label1.Visible = false;

			// Butonun MouseHover olayýný tanýmlayýn
			button10.MouseHover += new EventHandler(button10_MouseHover);

			// Butonun MouseLeave olayýný tanýmlayýn
		...
		{
			// Fare butonun üzerine geldiðinde label'ý göster
			label1.Text = "Çýkýþ";
			label1.Visible = true;
		}
		...
		{
			// Fare butonun üzerinden ayrýldýðýnda label'ý gizle
			label1.Visible = false;
		}
	}
}