namespace Projemiz
{
    partial class LRCcs
    {
		...
		private void InitializeComponent()
		{
			...
			// textBox1
			// 
			textBox1.Location = new Point(428, 505);
			...
			// textBox2
			// 
			textBox2.Location = new Point(82, 504);
			...
			// textBox3
			// 
			textBox3.Location = new Point(255, 505);
			...
			// textBox4
			// 
			textBox4.Location = new Point(601, 504);
			...
			label3.Font = new Font("Century Gothic", 36F, FontStyle.Regular, GraphicsUnit.Point);
			label3.Location = new Point(255, 57);
			label3.Name = "label3";
			label3.Size = new Size(445, 58);
			label3.TabIndex = 8;
			label3.Text = "LRC ALGORİTMASI";
			// 
			// button2
			// 
			...
			button2.Location = new Point(82, 594);
			...
			label4.Location = new Point(328, 782);
			label4.Name = "label4";
			...
			tableLayoutPanel1.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 12.5F));
			tableLayoutPanel1.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 12.5F));
			tableLayoutPanel1.Location = new Point(473, 594);
			...
			tableLayoutPanel1.RowStyles.Add(new RowStyle(SizeType.Percent, 20F));
			tableLayoutPanel1.RowStyles.Add(new RowStyle(SizeType.Percent, 20F));
			tableLayoutPanel1.Size = new Size(289, 155);
			...
			label5.Location = new Point(451, 782);
			label5.Name = "label5";
			...
			buttonYenile.Location = new Point(30, 909);
			buttonYenile.Margin = new Padding(3, 2, 3, 2);
			buttonYenile.Name = "buttonYenile";
			buttonYenile.Size = new Size(331, 45);
			...
			label6.Location = new Point(328, 594);
			label6.Name = "label6";
			...
			label7.Location = new Point(228, 497);
			label7.Name = "label7";
			...
			label8.Location = new Point(401, 498);
			label8.Name = "label8";
			...
			label9.Location = new Point(574, 498);
			label9.Name = "label9";
			...
			panel2.Location = new Point(234, 54);
			panel2.Name = "panel2";
			...
			button10.Location = new Point(25, 54);
			...
			panel3.Location = new Point(1450, 12);
			panel3.Name = "panel3";
			panel3.Size = new Size(175, 203);
			panel3.TabIndex = 45;
			// 
			// pictureBox1
			// 
			...
			pictureBox1.Size = new Size(147, 164);
			...
			button1.Location = new Point(82, 232);
			...
			button3.Location = new Point(1450, 232);
			...
			button5.Location = new Point(1164, 232);
			...
			label1.Location = new Point(82, 467);
			label1.Name = "label1";
			label1.Size = new Size(434, 19);
			label1.TabIndex = 49;
			...
			label10.TabIndex = 52;
			label10.Text = "Alınan Datayı Giriniz :";
			// 
			// button4
			// 
